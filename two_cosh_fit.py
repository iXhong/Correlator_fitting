...
def jk_mean_err(t_min,t_max,t,data):
    #get data to be fitted with jackknife
    ...
    jk_mean, jk_err = jackknife(f=func,data=data,numb_blocks=N_blocks,conf_axis=0,return_sample=False)
...
def main(show_plot=True,show_report=True):
    data, t,_= data_load()
    T = 96
