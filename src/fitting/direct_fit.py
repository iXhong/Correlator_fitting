...
class DirectFit(FitMethod):
    ...
    def _run_fit(self, t_fit, T, data_fit, sigma, residual, print_report=True) -> FitResult:
        ...
        return FitResult.create1param(A0, A0_err, m0, m0_err, redchi, aic, success_rate, method="Direct Fit")